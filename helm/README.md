...
`sandbox-envd-proxy` data plane, and the `nodeinventories.sandbox.cocoonstack.io`
CRD.
...
The e2b-compatible REST surface is off by default. Enabling it requires a
domain and a Secret of API keys:
